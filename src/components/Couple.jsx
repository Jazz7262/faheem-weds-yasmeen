                ...
                <div className="row">
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info groom-info">
                            <h3>
                                Soudagar Faheem Ahmed,
                                {/* <sub>MCA,</sub> */}
                            </h3>
                            <p className="mt-2 mt-lg-3">
                                Proprietor: <strong>Faheem Tailors,</strong> MIG
                                - 14, APHB Colony, Adoni.
                            </p>
                            ...
                            <p className="mt-1 mt-lg-2">
                                Grand S/O.
                                <strong>
                                    Soudagar Shaik Ahmad Sahab(Late).
                                </strong>
                            </p>
                            {/* <p className="mt-1 mt-lg-2">
              ...
              <p className="mt-1 mt-lg-2">Residence at RTC Colony, Adoni.</p> */}
                    ...
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info bride-info">
                            ...
                            <p className="mt-2 mt-lg-3">
                                D/O <strong>Janab S. Musthaq Sahab,</strong>
                            </p>
                            {/* <p className="mt-1 mt-lg-2">
                                Grand D/O Janab{" "}
